...
export default ({ setIsAuthenticated, setIsVendorName, setToken }) => {
  ...
  return (
    <>
        ...
        <a href="/contact">Contact us</a>
                ...
                <LoginForm setIsVendorName={setIsVendorName} setIsAuthenticated={setIsAuthenticated} setToken={setToken} />
              </div>
            </Col>
          </Row>
        </Container>
